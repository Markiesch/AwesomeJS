...
filter.addEventListener("input", generateProjects);

function generateProjects() {
  projectSection.innerHTML = ``;

  let filteredProjects = projects;
  if (filter) filteredProjects = projects.filter((project) => project.title.toLowerCase().includes(filter.value.toLowerCase()));
